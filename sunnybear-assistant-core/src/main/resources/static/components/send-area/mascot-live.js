...
(function (global) {
    ...
    var CFG = {
        // 呼吸
        breath: { periodMs: 4600, scale: 0.011, liftPx: 2.4 },
        // 头部跟随鼠标
        headFollow: { maxAngle: 1.7, maxShift: 1.2, ease: 0.085 },
        // 上身轻摆
        bodyFollow: { maxAngle: 0.55, ease: 0.07 },
        // 眼仁跟随（range = 眼白内可用的最大偏移比例）
        iris: { range: 0.72, ease: 0.15 },
        // 眨眼
        ...
        // 刘海飘动
        hair: { periodMs: 5600, angleDeg: 0.85, skewDeg: 0.65 }
    };
